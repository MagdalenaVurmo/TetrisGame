class Tetris {
    ...
    clearLines() {
        ...
        if (linesCleared > 0) {
            this.score +=
                [40, 100, 300, 1200][linesCleared - 1] *
                this.level;
    ...
    drawNextPiece() {
        ...
        const offsetX =
            (4 - this.nextPiece.shape[0].length) / 2;

        const offsetY =
            (4 - this.nextPiece.shape.length) / 2;
...
// Koppla tangentbordet och startknappen
game.bindEvents();